...
birthData <- read.csv2("./data/raw/vie_201.csv", header = TRUE, sep=";", skip = 1)
...
meanTempDeviation <- read.csv2("cli_iad_td.tsv", header = TRUE, sep="\t")
...
write.csv2(data, "./data/processed/mergedData.csv")
